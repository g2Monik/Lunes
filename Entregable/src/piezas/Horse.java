...
public class Horse {
	...
	public static void horseMove(int x, int y) {
        ...
        try {			
				if (x == 0 && y == 0 && Layout.casilla[x+1][y+2] != "W" && Layout.casilla[x+2][y+1] != "W") { // Posiciones de X=0
					Layout.buttons[x + 1][y + 2].setBackground(Color.GREEN);
					Layout.buttons[x + 2][y + 1].setBackground(Color.GREEN);
				} else if (x == 0 && y == 1 && Layout.casilla[x+1][y+2] != "B" &&
						Layout.casilla[x+2][y+1] != "B" && Layout.casilla[x+2][y-1] != "B") {
					Layout.buttons[x + 1][y + 2].setBackground(Color.GREEN);
					Layout.buttons[x + 2][y + 1].setBackground(Color.GREEN);
					Layout.buttons[x + 2][y - 1].setBackground(Color.GREEN);
				} else if (x == 0 && (2 < y && y <= 5 && Layout.casilla[x][y] != "W")) {
					Layout.buttons[x + 1][y + 2].setBackground(Color.GREEN);
					Layout.buttons[x + 2][y + 1].setBackground(Color.GREEN);
					Layout.buttons[x + 2][y - 1].setBackground(Color.GREEN);
					Layout.buttons[x + 1][y - 2].setBackground(Color.GREEN);
